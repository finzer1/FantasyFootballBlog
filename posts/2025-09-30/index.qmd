---
title: "Assessing Past QB Data Using Correlation and Regression"
...
Link to AI Transcript: not appliable
...
Below, we are able to see the association of target share and fantasy points among quarterbacks.
...
According to the results, this indicates a very weak negative linear correlation between the two variables (i.e., as target_share increases, fantasyPoints decreases). Additionally, the results also show a statistically significant relationship. 
...
Below, we have a linear regression model with one predictor, pass attempts, predicting completion percentage among Quarterbacks.
...
Below, we have a linear regression model that adds the player's age as a covariate to control for age.
...
After reviewing all of my findings, hypotheses #2 and #3 were supported (i.e., results were statistically significant) as well as predictions #2 and #3 (i.e., general direction was predicted accurately) while hypothesis #1 was partially supported (i.e., results were statistically significant) and prediction #1 was not supported (general direction was not predicted accurately). These findings are important because it can potentially help people choose a quarterback based on the results of real-life data. These results can also help  coaches when determining who their quarterback should be. 
